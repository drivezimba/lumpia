...
class Telegram extends Client {
   ...
   * @returns
   */
  setMessageReaction(chatId, messageId, reaction, is_big) {
   ...
   */
  editForumTopic(chatId, message_thread_id, extra) {
  ...
  editGeneralForumTopic(chatId, name) {
    return this.callApi("editGeneralForumTopic", { chatId, name });
  }
  /**
  ...
  closeGeneralForumTopic(chatId) {
    return this.callApi("closeGeneralForumTopic", { chatId });
  }
  /**
  ...
  reopenGeneralForumTopic(chatId) {
    return this.callApi("reopenGeneralForumTopic", { chatId });
  }
  /**
  ...
  hideGeneralForumTopic(chatId) {
    return this.callApi("hideGeneralForumTopic", { chatId });
  }
  /**
  ...
  unhideGeneralForumTopic(chatId) {
    return this.callApi("unhideGeneralForumTopic", { chatId });
  }
  /**
  ...
  unpinAllGeneralForumTopicMessages(chatId) {
    return this.callApi("unpinAllGeneralForumTopicMessages", { chatId });
  }
  /**
